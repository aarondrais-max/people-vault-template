# People Team Knowledge Vault — Agent Instructions (Comp & Total Rewards)

This is a local Comp & Total Rewards knowledge vault maintained by an AI agent. When operating in this project, follow all conventions below exactly.
